...
@section('container')
                ...
                <div class="d-inline-block align-items-center pb-0">
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah Laporan Insiden Signifikan</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="form-check form-check-inline">
                                            <input type="text" class="form-control" id="unLap" name="unit_kerja"
                                                ...
                                                required {{ Auth::user()->role !== 'user' ? '' : 'readonly' }}>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 ms-auto mt-3">
                                <div class="d-flex align-items-center">
                                    <label for="pemLap" class="form-label text-bold">Pembuat Laporan
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label>
                                    <div class="form-group mb-0">
                                        <div class="form-check form-check-inline">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" class="form-control" id="noRMLap" name="noRM" placeholder=""
                                    required readonly>
                                <div class="invalid-feedback">
                        ...
                        <div class="row my-3">
                            ...
                            {{-- NO Reg --}}
                            <div class="col-sm-6">
                                <label for="noRegLap" class="form-label text-bold">No Reg</label>
                                <input type="text" class="form-control" id="noRegLap" name="noReg" placeholder=""
                                    required>
                                <div class="invalid-feedback">
                                    Valid No Reg is required.
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="form-check form-check-inline">
                                            <input id="jekel1" name="jenis_kelamin" type="radio"
                                                class="form-check-input" value="Laki-laki" required onclick="return false"
                                                style="pointer-events: none">
                                            <label class="form-check-label" for="jekel1">Laki-laki</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input id="jekel2" name="jenis_kelamin" type="radio"
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="form-check form-check-inline">
                                            <input type="date" class="form-control" id="talah"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="penjamin" name="penjamin"
                                    placeholder="" required readonly>
                                <div class="invalid-feedback">
                                    Valid Penjamin is required.
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 my-3">
                            ...
                            <input type="text" class="form-control" id="inLap" name="insiden"
                                placeholder="Insiden apa yang terjadi" value="" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" class="form-control" id="kronLap" name="kronologis"
                                placeholder="Bagaimana kronologis dari insiden tersebut" value="" required></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12 my-3">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline  ms-3">
                                            <input id="jenLap1" name="jenis_insiden" type="radio"
                                                class="form-check-input"
                                                value="Kondisi Potensial Cedera Signifikan / KPCS" required>
                                            <label class="form-check-label" for="jenLap1">Kondisi Potensial Cedera /
                                                KPCS</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline  ms-3">
                                            <input id="jenLap2" name="jenis_insiden" type="radio"
                                                class="form-check-input" value="Kejadian Tidak Diharapkan / KTD" required>
                                            <label class="form-check-label" for="jenLap2">Kejadian Tidak Diharapkan /
                                                KTD</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline  ms-3">
                                            <input id="jenLap3" name="jenis_insiden" type="radio"
                                                class="form-check-input" value="Kejadian Nyaris Cedera / KNC" required>
                                            <label class="form-check-label" for="jenLap3">Kejadian Nyaris Cedera /
                                                KNC</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline  ms-3">
                                            <input id="jenLap4" name="jenis_insiden" type="radio"
                                                class="form-check-input" value="Sentinel" required>
                                            <label class="form-check-label" for="jenLap4">Sentinel</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline  ms-3">
                                            <input id="jenLap5" name="jenis_insiden" type="radio"
                                                class="form-check-input" value="Kejadian Tidak Cedera / KTC" required>
                                            <label class="form-check-label" for="jenLap5">Kejadian Tidak Cedera /
                                                KTC</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {{-- PELAPOR INSIDEN --}}
                        <div class="col-md-12">
                            <label for="pelapor_insiden" class="form-label me-3 text-bold">5. Orang Pertama yang
                                Melaporkan
                                Insiden</label>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline ms-3">
                                            <input id="penLap1" name="pelapor_insiden" type="radio"
                                                class="form-check-input"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline ms-3">
                                            <input id="penLap2" name="pelapor_insiden" type="radio"
                                                class="form-check-input" value="Pasien" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline ms-3">
                                            <input id="penLap3" name="pelapor_insiden" type="radio"
                                                class="form-check-input" value="Pengunjung" required>
                                            <label class="form-check-label" for="penLap3">Pengunjung</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline ms-3">
                                            <input id="penLap4" name="pelapor_insiden" type="radio"
                                                class="form-check-input" value="Keluarga / Pendamping" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline  ms-3">
                                            <input id="korLap1" name="korban_insiden" type="radio"
                                                class="form-check-input" value="Pasien" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-check form-check-inline p-0">
                                    <div class="input-group">
                                        <div class="input-group-text">
                                            <input id="inLap4" name="layanan_insiden"
                                                class="form-check-input mt-0 ms-0" type="radio" value=""
                                                aria-label="Radio button for following text input">
                                            <label class=mb-2 for="inLap4"
                                                style="padding-left: 20px;height: 17px;"></label>
                                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="temLap" name="tempat_insiden"
                                placeholder="Dimana insiden terjadi" value="" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12 my-3">
                            <label for="kasus_insiden" class="form-label text-bold">9. Insiden terjadi pada pasien (
                                sesuai
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-check">
                                            <input id="kasus13" name="kasus_insiden[]" type="checkbox"
                                                class="form-check-input" value="Orthopedi dan Subspesialisasinya">
                                            <label class="form-check-label" for="kasus13">Orthopedi dan
                                                Subspesialiasinya</label>
                                        </div>
                                        ...
                                        <div class="form-check ps-0 ms-10">
                                            <div class="input-group">
                                                <div class="input-group-text">
                                                    <input id="kasus14" name="kasus_insiden[]"
                                                        class="form-check-input mt-0 ms-0" type="checkbox" value=""
                                                        aria-label="Radio button for following text input">
                                                    <label class=mb-2 for="kasus14"
                                                        style="padding-left: 20px;height: 17px;"></label>
                                                </div>
                                                <input id="kasus_lain" type="text" class="form-control"
                                                    aria-label="Text input with radio button" placeholder="Lain-lain"
                                                    onclick="selectRadio('kasus14')"
                                                    oninput="syncInputRadio('kasus14', 'kasus_lain')">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="unLap" name="unit_insiden"
                                placeholder="Unit / Departemen mana yang menyebabkan insiden" value="" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" class="form-control" id="tinCe" name="tindakan_cepat"
                                placeholder="Apa tindakan yang sudah dilakukan" value="" required></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12 my-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check ms-3">
                                    <input id="tinDil2" name="tindakan_insiden" type="radio"
                                        class="form-check-input" value="Dokter" required>
                                    <label class="form-check-label" for="tinDil2">Dokter</label>
                                </div>
                                <div class="form-check ms-3">
                                    <input id="tinDil3" name="tindakan_insiden" type="radio"
                                        class="form-check-input" value="Perawat" required>
                                    <label class="form-check-label" for="tinDil3">Perawat</label>
                                </div>
                                <div class="form-check ps-0">
                                    <div class="input-group">
                                        <div class="input-group-text">
                                            <input id="tinDil4" name="tindakan_insiden"
                                                class="form-check-input mt-0 ms-0" type="radio" value=""
                                                aria-label="Radio button for following text input">
                                            <label class=mb-2 for="tinIn4"
                                                style="padding-left: 20px;height: 17px;"></label>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <label for="kejadian_insiden" class="form-label text-bold">14. Apakah kejadian yang sama
                                pernah terjadi di Unit Kerja lain?</label>
                            <div class="form-group">
                                <div class="form-check ms-3">
                                    <input id="kejadian1" name="kejadian_insiden" type="radio"
                                        class="form-check-input" value="ya" onclick="showTextarea('ket_unit_kerja')"
                                        required>
                                ...
                                <div class="form-check ms-3">
                                    <input id="kejadian2" name="kejadian_insiden" type="radio"
                                        class="form-check-input" value="Tidak" onclick="hideTextarea('ket_unit_kerja')"
                                        required>
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="status_pelapor" class="form-label text-bold">Melapor sebagai</label>
                            <select class="form-control select2" id="status_pelapor" name="status_pelapor"
                                style="width: 100%;">
                                <option selected disabled>Pilih salah satu</option>
                                <option value="Penemu Insiden">Penemu Insiden</option>
                                <option value="Terlibat dalam Insiden">Terlibat dalam Insiden</option>
                            </select>
                            <div class="invalid-feedback">
                                Valid Ruangan is required.
                            </div>
                                        ...
                                        <div class="signature mb-3">
                                            <div class="text-right  d-flex justify-content-center">
                                                <button type="button" class="btn btn-default btn-sm me-1"
                                                    id="undo"><i class="fa fa-undo"></i> Undo</button>
    ...
    @include('script.lapin.add')
    @include('script.helper.autoSelectRadio')
    @include('script.helper.addSignature')
@endsection
