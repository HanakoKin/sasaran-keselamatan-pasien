...
@section('container')
                                        ...
                                        <div class="d-block align-items-center pb-0">
                                            <nav>
                                                <ol class="breadcrumb mb-0">
                                                    ...
                                                    <li class="breadcrumb-item active" aria-current="page">Verifikasi
                                                        Laporan Insiden
                                                    </li>
                                                </ol>
                                            </nav>
                                ...
                                <div class="box box-widget widget-user shadow-none">
                                    <div class="box-footer py-0 border-0">
                                        <div class="d-flex justify-content-between align-items-center m-20">
                                            <img src="{{ asset('assets/images/Husada.png') }}" width="70"
                                                alt="">
                                            <div class="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <h5>12. Tindakan yang dilakukan segera setelah kejadian, dan
                                                            hasilnya :</h5>
                                                    </div>
                                                    <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <h5>14. Apakah kejadian yang sama pernah terjadi di unit kerja lain?
                                                        </h5>
                                                    </div>
                                                    <div class="col-12">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>Paraf</td>
                                                                <td><img src="{{ $data->paraf_pelapor }}" alt=""
                                                                        width="200">
                                                                </td>
                                                                <td>Paraf</td>
                                                                <td class="min-w-200">
                                                                    @if ($data->paraf_penerima !== null)
                                                                        <img src="{{ $data->paraf_penerima }}"
                                                                            alt="" width="200">
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                ...
                                                @if (
                                                    ...
                                                    <div class="col-md-12 mb-5">
                                                        <label for="grading_risiko"
                                                            class="form-label me-3 text-bold fs-20">Grading Risiko
                                                            Kejadian</label>
                                                        ...
                                                        <h4 class="box-title mt-20"><strong>II. RINCIAN KEJADIAN</strong>
                                                        </h4>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <h5>10. Unit / Departemen terkait yang menyebabkan insiden :
                                                                </h5>
                                                            </div>
                                                            <div class="col-12">
                                                                <p class="ms-4">{{ $data->unit_insiden }}</p>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <h5>14. Apakah kejadian yang sama pernah terjadi di unit
                                                                    kerja lain? </h5>
                                                            </div>
                                                            <div class="col-12">
                                                                <p class="ms-4">{{ $data->kejadian_insiden }}</p>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>Paraf</td>
                                                                        <td><img src="{{ $data->paraf_pelapor }}"
                                                                                alt="" width="200">
                                                                        </td>
                                                                        <td>Paraf</td>
                                                                        <td class="min-w-200"><img
                                                                                src="{{ $data->paraf_penerima }}"
                                                                                alt="" width="200"></td>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
    ...
    {{-- Modal Verification --}}
    @include('modal.helper.verification')

    {{-- JS for Showing Modal --}}
    @include('script.helper.verification')
@endsection
