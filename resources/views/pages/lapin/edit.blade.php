...
@section('container')
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 ms-auto mt-3">
                                <div class="d-flex align-items-center">
                                    <label for="editPemLap" class="form-label text-bold">Pembuat Laporan
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label>
                                    <div class="form-group mb-0">
                                        <div class="form-check form-check-inline">
                                            <input type="text" class="form-control" id="editPemLap"
                                                name="pembuat_laporan" value="{{ $data->pembuat_laporan }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="invalid-feedback">
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="form-check form-check-inline">
                                            <input type="date" class="form-control" id="talah"
                                                name="tanggal_lahir" value="{{ $data->tanggal_lahir }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="umur" name="umur" placeholder=""
                                    required readonly value="{{ $data->umur }}">
                            </div>

                            {{-- PENJAMIN --}}
                            <div class="col-md-6">
                                <label for="editPenLap" class="form-label text-bold">Penjamin</label>
                                <input type="text" class="form-control" id="editPenLap" name="penjamin"
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" class="form-control" id="editKronoLap" name="kronologis" placeholder="How is it happen"
                                required data-validation-required-message="This field is required">{{ $data->kronologis }}</textarea>
                        </div>
                        ...
                        <div class="col-md-12 my-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline ms-3">
                                            <input name="jenis_insiden" value="Sentinel" type="radio" id="jenIn4"
                                                required data-validation-required-message="This field is required"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline ms-3">
                                            <input name="jenis_insiden" value="Kejadian Tidak Cedera / KTC"
                                                type="radio" id="jenIn5" required
                                                data-validation-required-message="This field is required"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline ms-3">
                                            <input name="pelapor_insiden" value="Pasien" type="radio" id="pelIn3"
                                                required data-validation-required-message="This field is required"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline ms-3">
                                            <input name="pelapor_insiden" value="Pengunjung" type="radio"
                                                id="pelIn4" required
                                                data-validation-required-message="This field is required"
                                        ...
                                        <div class="form-check form-check-inline ms-25 mt-2 p-0">
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    <input name="pelapor_insiden" type="radio" id="pelIn5"
                                                        value="" required
                                                        data-validation-required-message="This field is required"
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-text">
                                                    <input name="korban_insiden" type="radio"
                                                        class="form-check-input mt-0 ms-0" id="korIn2" value=""
                                                        required data-validation-required-message="This field is required"
                                                        {{ $data->korban_insiden !== 'Pasien' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group d-flex justify-content-between align-items-center">
                                <div class="form-check form-check-inlne ms-3">
                                    <input name="layanan_insiden" type="radio" value="Pasien rawat inap"
                                        id="layIn1" required data-validation-required-message="This field is required"
                                        {{ $data->layanan_insiden === 'Pasien Rawat Inap' ? 'checked' : '' }}>
                                    <label for="layIn1">Pasien rawat inap</label>
                                </div>
                                <div class="form-check form-check-inlne ms-3">
                                    <input name="layanan_insiden" type="radio" value="Pasien rawat jalan"
                                        id="layIn2" required data-validation-required-message="This field is required"
                                        {{ $data->layanan_insiden === 'Pasien Rawat Jalan' ? 'checked' : '' }}>
                                    <label for="layIn1">Pasien rawat jalan</label>
                                </div>
                                <div class="form-check form-check-inlne ms-3">
                                    <input name="layanan_insiden" type="radio" value="Pasien UGD" id="layIn3"
                                        required data-validation-required-message="This field is required"
                                ...
                                <div class="form-check form-check-inlne p-0">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <input name="layanan_insiden" type="radio" id="layIn4" value=""
                                                required data-validation-required-message="This field is required"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check">
                                            <div class="input-group mt-2">
                                                <span class="input-group-addon">
                                                    <input type="checkbox" id="insiden14" name="kasus_insiden[]"
                                                        value=""
                        ...
                        <div class="col-md-12 my-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline ms-3">
                                    <input name="dampak_insiden" type="radio" value="Tidak ada cedera" id="akIn5"
                                        required data-validation-required-message="This field is required"
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" id="editTinCepLap" class="form-control" name="tindakan_cepat"
                                placeholder="How is it happen" required data-validation-required-message="This field is required">{{ $data->tindakan_cepat }}</textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12 my-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check ms-3">
                                    <input name="tindakan_insiden" type="radio" value="Perawat" id="tinIn3"
                                        required data-validation-required-message="This field is required"
                            ...
                            <div class="form-group">
                                <div class="form-check ms-3">
                                    <input id="pernah1" name="kejadian_insiden" type="radio"
                                        class="form-check-input" value="Ya" onclick="showTextarea('textarea_pernah')"
                                        required {{ strpos($data->kejadian_insiden, 'Ya,') !== false ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select class="form-control select2" id="status_pelapor" name="status_pelapor"
                                style="width: 100%;">
                                <option value="Penemu Insiden"
                                    {{ $data->status_pelapor == 'Penemu Insiden' ? 'selected' : '' }}>Penemu Insiden
                                </option>
                                <option value="Terlibat dalam Insiden"
                                    {{ $data->status_pelapor == 'Terlibat dalam Insiden' ? 'selected' : '' }}>Terlibat
                                    dalam
                                    Insiden</option>
                            </select>
                            <div class="invalid-feedback">
    ...
    @include('script.lapin.edit')
    @include('script.helper.autoSelectRadio')
    @include('script.helper.editProcess')
    @include('script.helper.editSignature')
@endsection
