                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <textarea rows="5" class="form-control" id="editKPC" name="kpc" placeholder="How is it happen" required
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="radio">
                                            <div class="input-group mt-2">
                                                <span class="input-group-addon">
                                                    <input name="tindakan_insiden" type="radio" id="tinIn1"
                                                        value="" required
                                                        data-validation-required-message="This field is required"
                                        ...
                                        <div class="radio">
                                            <input name="tindakan_insiden" type="radio" value="Dokter" id="tinIn2"
                                                required data-validation-required-message="This field is required"
                                        ...
                                        <div class="radio">
                                            <div class="input-group mt-2">
                                                <span class="input-group-addon">
                                                    <input name="tindakan_insiden" type="radio" id="tinIn4"
                                                        value="" required
                                                        data-validation-required-message="This field is required"
                                                ...
                                                <input id="tindakan_lain" type="text" class="form-control"
                                                    ...
                                                    placeholder="Petugas lainnya" onclick="selectRadio('tinIn4')"
