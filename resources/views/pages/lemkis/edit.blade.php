    ...
    <section class="content pt-0">
        ...
        <div class="row">
            <div class="col-12">
                ...
                {{-- Form --}}
                <form action="{{ route('updateLemkis', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data"
                    id="formId">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control" name="penyebab_langsung" placeholder="How is it happen" required
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control" name="penyebab_awal" placeholder="How is it happen" required
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <textarea rows="3" class="form-control" name="rekom_invest_pendek" placeholder="How is it happen">{{ $data->rekom_invest_pendek }}</textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <textarea rows="3" class="form-control" name="rekom_invest_menengah" placeholder="How is it happen">{{ $data->rekom_invest_menengah }}</textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <textarea rows="3" class="form-control" name="rekom_invest_panjang" placeholder="How is it happen">{{ $data->rekom_invest_panjang }}</textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="form-label">Jangka Pendek :</label>
                                                <textarea rows="3" class="form-control" name="realisasi_invest_pendek" placeholder="How is it happen">{{ $data->realisasi_invest_pendek }}</textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    name="penanggung_realisasi_pendek"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="form-label">Jangka Menengah :</label>
                                                <textarea rows="3" class="form-control" name="realisasi_invest_menengah" placeholder="How is it happen">{{ $data->realisasi_invest_menengah }}</textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    name="penanggung_realisasi_menengah"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="form-label">Jangka Panjang :</label>
                                                <textarea rows="3" class="form-control" name="realisasi_invest_panjang" placeholder="How is it happen">{{ $data->realisasi_invest_panjang }}</textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    name="penanggung_realisasi_panjang"
                                                        ...
                                                        <div class="form-group mb-0">
                                                            <div class="form-group mb-0 d-flex align-items-center">
                                                                <div class="radio me-3">
                                                                    <input name="invest_lengkap" value="ya"
                                                                        type="radio" id="inLen1" required
                                                                        data-validation-required-message="This field is required"
                                                                        {{ $data->invest_lengkap === 'ya' ? 'checked' : '' }}>
                                                                    <label for="inLen1" class="me-1">Ya</label>
                                                                </div>
                                                                <div class="radio">
                                                                    <input name="invest_lengkap" value="tidak"
                                                                        type="radio" id="inLen2" required
                                                                        data-validation-required-message="This field is required"
                                                ...
                                                <div class="row mt-10">
                                                    ...
                                                    <div class="col-4 ps-2">
                                                        <div class="form-group mb-0">
                                                            <div class="form-group mb-0 d-flex align-items-center">
                                                                <div class="radio me-3">
                                                                    <input name="invest_lanjut" value="ya"
                                                                        type="radio" id="inLan1" required
                                                                        data-validation-required-message="This field is required"
                                                                        {{ $data->invest_lanjut === 'ya' ? 'checked' : '' }}>
                                                                    <label for="inLan1" class="me-1">Ya</label>
                                                                </div>
                                                                <div class="radio">
                                                                    <input name="invest_lanjut" value="tidak"
                                                                        type="radio" id="inLan2" required
                                                                        data-validation-required-message="This field is required"
                                                    ...
                                                    <div class="col-7 ps-3">
                                                        <div class="form-group mb-0">
                                                            <div class="form-group mb-0 d-flex align-items-left">
                                                                <div class="radio me-3">
                                                                    <input name="grading_akhir" value="biru"
                                                                        type="radio" id="gradUl1" required
                                                                        data-validation-required-message="This field is required"
                                                                        {{ $data->grading_akhir === 'biru' ? 'checked' : '' }}>
                                                                    <label for="gradUl1" class="me-1">Biru</label>
                                                                </div>
                                                                <div class="radio me-3">
                                                                    <input name="grading_akhir" value="hijau"
                                                                        type="radio" id="gradUl2" required
                                                                        data-validation-required-message="This field is required"
                                                                        {{ $data->grading_akhir === 'hijau' ? 'checked' : '' }}>
                                                                    <label for="gradUl2" class="me-1">Hijau</label>
                                                                </div>
                                                                <div class="radio me-3">
                                                                    <input name="grading_akhir" value="kuning"
                                                                        type="radio" id="gradUl3" required
                                                                        data-validation-required-message="This field is required"
                                                                        {{ $data->grading_akhir === 'kuning' ? 'checked' : '' }}>
                                                                    <label for="gradUl3" class="me-1">Kuning</label>
                                                                </div>
                                                                <div class="radio">
                                                                    <input name="grading_akhir" value="merah"
                                                                        type="radio" id="gradUl4" required
                                                                        data-validation-required-message="This field is required"
