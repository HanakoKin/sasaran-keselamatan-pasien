                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control" name="penyebab_langsung" placeholder="Apa penyebab langsung dari insiden"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control" name="penyebab_awal" placeholder="Apa yang menyebabkan insiden" required
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <textarea rows="3" class="form-control" name="rekom_invest_pendek" placeholder=""></textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <textarea rows="3" class="form-control" name="rekom_invest_menengah" placeholder=""></textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <textarea rows="3" class="form-control" name="rekom_invest_panjang" placeholder=""></textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    name="penanggung_rekom_panjang" placeholder="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="form-label">Jangka Pendek :</label>
                                                <textarea rows="3" class="form-control" name="realisasi_invest_pendek" placeholder=""></textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    name="penanggung_realisasi_pendek" placeholder="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="form-label">Jangka Menengah :</label>
                                                <textarea rows="3" class="form-control" name="realisasi_invest_menengah" placeholder=""></textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    name="penanggung_realisasi_menengah" placeholder="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="form-label">Jangka Panjang :</label>
                                                <textarea rows="3" class="form-control" name="realisasi_invest_panjang" placeholder=""></textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    name="penanggung_realisasi_panjang" placeholder="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="direksi"
                                        placeholder="Input nama direksi">
                                </div>
                                <div class="form-group">
