        ...
        <div class="row">
                                ...
                                <div class="w-p70">
                                    <div class="progress progress-sm mb-0">
                                        <div class="progress-bar bg-{{ $prosentaseSentinel >= 0 && $prosentaseSentinel <= 25 ? 'info' : ($prosentaseSentinel > 25 && $prosentaseSentinel <= 50 ? 'success' : ($prosentaseSentinel > 50 && $prosentaseSentinel <= 75 ? 'warning' : ($prosentaseSentinel > 75 ? 'danger' : ''))) }}"
                                            role="progressbar" aria-valuenow="{{ $prosentaseSentinel }}"
                                            aria-valuemin="0" aria-valuemax="100"
                                            style="width: {{ $prosentaseSentinel }}%">
                                        </div>
                                    </div>
                                </div>
                                <div>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="box pull-up">
                        <div class="box-body">
                            <div class="rounded" style="background-color: #0AD200">
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="box pull-up">
                        <div class="box-body">
                            <div class="rounded" style="background-color: #FFF100">
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="box pull-up">
                        <div class="box-body">
                            <div class="rounded" style="background-color: #FA0001">
            ...
            <div class="row">
                <div class="col-md-12 d-flex justify-content-between">
                    <button id="prevBtn" class="waves-effect waves-light btn btn-sm btn-outline btn-rounded btn-info"><i
                    ...
                    <button id="nextBtn"
                        class="waves-effect waves-light btn btn-sm btn-outline btn-rounded btn-info">Next Year
                        <i class="fas fa-caret-circle-right"></i></button>
                </div>
