...
@section('container')
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" id="password" name="password"
                                        class="form-control ps-15 bg-transparent" placeholder="Password" required>
                                    <span class="input-group-text bg-transparent" id="toggle-password"
                                        style="cursor: pointer;">
                                        <i class="fal fa-eye" id="eye-icon"></i>
                                    </span>
                                </div>
                            </div>
                            <div class="row">
    ...
    @include('script.auth.show-password')
@endsection
