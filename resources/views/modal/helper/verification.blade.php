<div class="modal fade bs-example-modal-lg" id="verifData" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                                                ...
                                                <div class="signature mb-0">
                                                    ...
                                                    <div class="button mt-2">
                                                        <button type="button" class="btn btn-info btn-sm"
                                                            id="save-png"><i class="fas fa-check-circle"></i> Preview &
                                                            Confirm</button>
                                                    </div>
...
@include('script.helper.verifDateData')
@include('script.helper.verLapSignature')
